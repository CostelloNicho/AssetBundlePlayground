...
public class AssetBundleAnalyzer : EditorWindow
{
    ...
    private UnityEngine.Object analyzedObject = null;
    ...
    {
        AssetBundleAnalyzer AssetBundleAnalyzerEditorWindow = (AssetBundleAnalyzer)EditorWindow.GetWindow(typeof(AssetBundleAnalyzer));
        AssetBundleAnalyzerEditorWindow.buildTarget = EditorUserBuildSettings.activeBuildTarget;
    }
    ...
    void OnGUI()
    {
        ...
        if (Selection.activeObject != null)
        {
            ...
            //if (assetPath.Contains("AssetBundles") && !assetPath.Contains(".Manifest"))
            //{
    ...
    private void analyzeAssetBundle(UnityEngine.Object obj, BuildTarget buildTarget)
    {
        typeStatusMap.Clear();
        typeSizeMap.Clear();
        statistics.Clear();
        ...
        UnityEngine.Object[] loadedObjects = www.assetBundle.LoadAllAssets();

        foreach (UnityEngine.Object loadedObj in loadedObjects)
        {
